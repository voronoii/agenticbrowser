...
- ask_human: 사용자에게 질문. 필드: question. **주의**: 스스로 판단할 수 있는 것은 질문하지 마세요. 정말 사용자만 결정할 수 있는 것만 물어보세요. question은 반드시 일반 사용자가 이해할 수 있는 평이한 언어로 작성하세요. "요소 목록", "인덱스", "index" 같은 내부 기술 용어는 절대 사용하지 마세요.
...
- ask_human 질문은 반드시 일반 사용자가 이해할 수 있는 쉬운 말로 작성하세요. "요소 목록", "인덱스", "index 번호" 같은 내부 기술 용어는 절대 사용하지 마세요. 예를 들어 "로그인 버튼의 인덱스를 알려주세요" 대신 "로그인은 어떻게 하나요? (아이디/비밀번호 또는 소셜 로그인)"처럼 물어보세요.
"""
